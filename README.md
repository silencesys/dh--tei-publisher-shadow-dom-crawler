...
```js
import { injectShadowStyles } from 'https://cdn.jsdelivr.net/gh/silencesys/dh--tei-publisher-shadow-dom-crawlers@latest/shadow-dom.js';
...
```html
<script src="https://cdn.jsdelivr.net/gh/silencesys/dh--tei-publisher-shadow-dom-crawlers@latest/shadow-dom.js@1.0.0/shadow-styles.js"></script>
```
